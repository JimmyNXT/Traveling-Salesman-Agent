...
class IHeuristic:
    ...
    def get_edge_value(
            self, current_vertex_id: int, next_vertex_id: int, previous_vertex_id:int, visited: list[int]
    ) -> float:
...
class HasVisitedHeuristic(IHeuristic):
    ...
    def get_edge_value(self, current_vertex_id: int, next_vertex_id: int, previous_vertex_id: int, visited: list[int]) -> float:
